...
import {
  ...
  Calendar, TrendingUp, Users, Briefcase, GraduationCap, Sparkles
} from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 dark:bg-secondary-800/50 backdrop-blur-sm border border-secondary-200 dark:border-secondary-700 mb-6">
                ...
                <span className="text-sm font-medium text-secondary-600 dark:text-secondary-300">About Me</span>
              </div>
            ...
            <div className="md:col-span-8 lg:col-span-9">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className="font-semibold text-secondary-900 dark:text-white mb-3">{skill.name}</div>
