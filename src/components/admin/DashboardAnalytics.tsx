...
const TagIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5a2 2 0 012 2v5a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 15h2v2H7v-2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 15h2v2h-2v-2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 20h10a2 2 0 002-2V7" /></svg>
);
const StarIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-12v4m-2-2h4m5 4v4m-2-2h4M17 3l-1.172 3.516a1 1 0 00.95 1.484h3.444" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 21l-1.172-3.516a1 1 0 00-.95-1.484H6.434" /></svg>
);
const CategoryIcon = () => (
...
const DashboardAnalytics: React.FC = () => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <StatCard title="Total Recommendations" value={stats.totalRecommendations} icon={<StarIcon />} />
